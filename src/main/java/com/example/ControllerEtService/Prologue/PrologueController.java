...
public class PrologueController {
    ...
    @DeleteMapping("/")
    public ResponseEntity<Prologue> deletePrologue(@RequestBody Integer identifiant ) {
        try {
            prologueService.deletePrologue(identifiant);
            return new ResponseEntity<Prologue>(HttpStatus.OK);
